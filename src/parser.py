...
def parameter_parser():
    ...
    # Skip-Gram
    parser.add_argument('--idx_embed', default="E20", type=str)
    ...
    parser.add_argument('--CSP_coef', default=0.01, type=float)

    # Metapath2vec - MetapathWalker
    parser.add_argument('--idx_metapath', default="M0", type=str)
